      ...
      <header>
        <div className="container mx-auto flex items-center justify-between h-full">
          <div className="flex items-center gap-3">
            <Image src="" alt="" width={60} height={60} className="" />
            <span className="font-bold text-[24.7px] tracking-[1.65px] text-[#1a1a1a]">
              BRIGHTMINDS
            </span>
          </div>
          <div className="flex-1 max-w-[409px]  mx-auto">
            <div className="flex items-center gap-4 p-4 bg-[#f7931e0a] rounded-[18px] border border-[#f7931e]">
              <Search className="w-[18px] h-[18px] text-[#6f6f6f]" />
              <Input
                className="border-none bg-transparent placeholder:text-[#6f6f6f]"
